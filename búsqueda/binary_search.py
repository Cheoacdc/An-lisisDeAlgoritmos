...
def binary_search_m(
    arr: List, x: Union[int, float], i: int, j: int, best: int
) -> Union[int, None]:
    m = math.ceil((i + j - 1)/2)
    if x == arr[m]:
        return m
...
# print(7, binary_search_m(arr, 7, 0, len(arr) - 1, 0))
# print(2, binary_search_m(arr, 2, 0, len(arr) - 1, 0))
# print(8, binary_search_m(arr, 8, 0, len(arr) - 1, 0))
# print(10, binary_search_m(arr, 10, 0, len(arr) - 1, 0))
# print(12, binary_search_m(arr, 12, 0, len(arr) - 1, 0))
# print(16, binary_search_m(arr, 16, 0, len(arr) - 1, 0))
# print(35, binary_search_m(arr, 35, 0, len(arr) - 1, 0))
